...
class Model_LightningModule(pl.LightningModule):
	def __init__(self, args):
		...
		# Loss
		self.train_lossfn = losses.PerceptualConvergenceLoss()
	...
	def training_step(self, batch, batch_idx):
		...
		train_loss = self.train_lossfn(y1_pred, y2_pred, y)
...
def main(args):
	...
	best_checkpoint_callback = ModelCheckpoint(
		...
		filename="supervised_best_model",
	)
...
--resume-ckpt-path "/work/09076/dks2000/ls6/Video-Interpolation/checkpoints/davis/modified_vrt_config0/supervised_best_model.ckpt" \
--load-weights-ckpt-path "/work/09076/dks2000/ls6/Video-Interpolation/checkpoints/davis/modified_vrt_config0/self_supervised_best_model.ckpt" \
--epochs 50 \
--batch-size 1 \
--lr 0.001 \
--num-nodes 2 \
